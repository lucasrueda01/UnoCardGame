...
public class MazoPrincipal extends Pila {
	...
	// Bandera para registrar cuando un jugador roba una carta del mazo, y no pueda
	// volver a robar en el mismo turno
	...
	/**
	 * Crea el mazo de cartas inicial, incluyendo cartas normales, especiales y
	 * comodines.
	 */
	private void crear() {
